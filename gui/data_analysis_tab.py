...
P_ttv (en époques)       : {p_ttv_epoch_moy:.4f} +/- {p_ttv_epoch_err:.4f}
Période Modulation TTV   : {p_ttv_jours_moy:.4f} +/- {p_ttv_jours_err:.4f} jours
Ratio (P_ttv / P_orb)    : {ratio_p_ttv_p_orb:.4f} (sans unité)
